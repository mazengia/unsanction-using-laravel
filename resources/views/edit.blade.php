    ...
    <div class=" justify-content-center" >
            <div style=" border-radius: 100px;" class="card border-0 "  >
                <div   align="center"    class="card-header">
                    <h3>Update Detail Information</h3><br>
                </div>

                <div class="card-body">
                    @foreach($data as $row)
                        @if($message = Session::get('success'))
                            <div  style="width: 50%; margin-left: 25%"  class="alert alert-success alert-block">
                                <button type="button" class="close" data-dismiss="alert">x</button>
                               <strong>{{ $message }}</strong>
                            </div>
                        @endif
                         @if($message = Session::get('error'))
                            <div  style="width: 50%; margin-left: 25%"  class="alert alert-danger alert-block">
                                <button type="button" class="close" data-dismiss="alert">x</button>
                               <strong>{{ $message }}</strong>
                            </div>
                        @endif
